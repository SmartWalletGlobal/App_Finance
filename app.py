...
def obter_dados_usuario(username):
  try:
    response = (
        supabase.table("usuarios")
        .select("nome_completo, endereco, foto_perfil, ramo_atividade")
        .eq("username", username)
        .execute()
    )
    if response.data and len(response.data) > 0:
      ...
      return (
          ...
          user.get("endereco"),
          user.get("foto_perfil"),
          user.get("ramo_atividade"),
      )
    return None
  except Exception as e:
    return None
...
CATEGORIAS_CHAVES = {
    ...
    "outros": {
        "desp": [
            "aluguel_prestacao_casa",
            "agua_gas_energia",
            "impostos_taxas_geral",
            "investimentos_reservas",
            "transportes_combustivel",
            "alimentacao_supermercado",
            "saude_farmacia",
            "lazer_outras_despesas",
        ],
        "rec": [
            "salario_base",
            "receitas_variaveis",
...
TRADUCOES_RAMOS = {
    "Português": {
        ...
        "cat_nomes": {
            ...
            "pagamento_clientes": "Pagamento de Clientes",
            ...
            "mao_de_obra": "Mão de Obra / Subcontratados",
            "combustivel_frete": "Combustível / Frete",
            "medicao_obra": "Medição de Obra",
            "adiantamento_sinal": "Adiantamento / Sinal",
            "venda_sobras": "Venda de Sobras",
            "softwares_assinaturas": "Softwares / Assinaturas",
            "hospedagem_servidores": "Hospedagem / Servidores",
            "marketing": "Marketing",
            "cursos_capacitacao": "Cursos / Capacitação",
            "desenvolvimento_projetos": "Desenvolvimento de Projetos",
            "consultoria": "Consultoria",
            "suporte_mensal": "Suporte Mensal (Retainer)",
            "aquisicao_mercadorias": "Aquisição de Mercadorias",
            "embalagens": "Embalagens",
            "frete_logistica": "Frete / Logística",
            "marketing_anuncios": "Marketing / Anúncios",
            "vendas_vista": "Vendas à Vista",
            "vendas_cartao_pix": "Vendas no Cartão / Pix",
            "vendas_parceladas": "Vendas Parceladas",
            "aluguel_prestacao_casa": "Aluguel / Prestação da Casa",
            "agua_gas_energia": "Água, Gás e Energia Elétrica",
            "impostos_taxas_geral": "Impostos e Taxas (IPTU, IPVA, IR)",
            "investimentos_reservas": "Investimentos e Reservas",
            "transportes_combustivel": "Transportes e Combustível",
            "alimentacao_supermercado": "Alimentação e Supermercado",
            "saude_farmacia": "Saúde e Farmácia",
            "lazer_outras_despesas": "Lazer e Outras Despesas",
            "salario_base": "Salário Base",
            "receitas_variaveis": "Receitas Variáveis (Diárias / Bicos)",
            "investimentos_rendimentos": "Investimentos e Rendimentos",
            "outros_ganhos": "Outros Ganhos / Outras Receitas",
        },
    },
    "English": {
        ...
        "tipo_receita": "Income",
        "cat_nomes": {
            "pecas_insumos": "Parts / Supplies",
            "ferramentas": "Tools",
            "equipamentos": "Equipment",
            "manutencao_predial": "Building Maintenance",
            "aluguel": "Rent",
            "impostos_taxas": "Taxes / Fees",
            "outras_despesas": "Other Expenses",
            "pagamento_clientes": "Client Payments",
            "servicos_realizados": "Services Rendered",
            "venda_pecas": "Parts Sales",
            "orcamentos_aprovados": "Approved Budgets",
            "salario": "Salary",
            "outras_receitas": "Other Income",
            "materiais_construcao": "Building Materials",
            "mao_de_obra": "Labor / Subcontractors",
            "combustivel_frete": "Fuel / Freight",
            "medicao_obra": "Construction Measurement",
            "adiantamento_sinal": "Advance / Deposit",
            "venda_sobras": "Surplus Sales",
            "softwares_assinaturas": "Software / Subscriptions",
            "hospedagem_servidores": "Hosting / Servers",
            "marketing": "Marketing",
            "cursos_capacitacao": "Courses / Training",
            "desenvolvimento_projetos": "Project Development",
            "consultoria": "Consulting",
            "suporte_mensal": "Monthly Support (Retainer)",
            "aquisicao_mercadorias": "Goods Acquisition",
            "embalagens": "Packaging",
            "frete_logistica": "Freight / Logistics",
            "marketing_anuncios": "Marketing / Ads",
            "vendas_vista": "Cash Sales",
            "vendas_cartao_pix": "Card / Pix Sales",
            "vendas_parceladas": "Installment Sales",
            "aluguel_prestacao_casa": "Rent / House Installment",
            "agua_gas_energia": "Water, Gas & Electricity",
            "impostos_taxas_geral": "Taxes & Fees",
            "investimentos_reservas": "Investments & Reserves",
            "transportes_combustivel": "Transport & Fuel",
            "alimentacao_supermercado": "Groceries & Food",
            "saude_farmacia": "Health & Pharmacy",
            "lazer_outras_despesas": "Leisure & Other Expenses",
            "salario_base": "Base Salary",
            "receitas_variaveis": "Variable Income (Daily work / Extras)",
            "investimentos_rendimentos": "Investments & Yields",
            "outros_ganhos": "Other Earnings",
        },
    },
    "Français": {
        ...
        "tipo_receita": "Revenu",
        "cat_nomes": {
            "pecas_insumos": "Pièces / Consommables",
            "ferramentas": "Outils",
            "equipamentos": "Équipement",
            "manutencao_predial": "Maintenance des Locaux",
            "aluguel": "Loyer",
            "impostos_taxas": "Impôts / Taxes",
            "outras_despesas": "Autres Dépenses",
            "pagamento_clientes": "Paiement des Clients",
            "servicos_realizados": "Services Réalisés",
            "venda_pecas": "Vente de Pièces",
            "orcamentos_aprovados": "Devis Approuvés",
            "salario": "Salaire",
            "outras_receitas": "Autres Revenus",
            "materiais_construcao": "Matériaux de Construction",
            "mao_de_obra": "Main-d'œuvre / Sous-traitants",
            "combustivel_frete": "Carburant / Fret",
            "medicao_obra": "Mesurage de Chantier",
            "adiantamento_sinal": "Acompte / Avance",
            "venda_sobras": "Vente de Surplus",
            "softwares_assinaturas": "Logiciels / Abonnements",
            "hospedagem_servidores": "Hébergement / Serveurs",
            "marketing": "Marketing",
            "cursos_capacitacao": "Formations",
            "desenvolvimento_projetos": "Développement de Projets",
            "consultoria": "Conseil",
            "suporte_mensal": "Support Mensuel (Retainer)",
            "aquisicao_mercadorias": "Achat de Marchandises",
            "embalagens": "Emballages",
            "frete_logistica": "Fret / Logistique",
            "marketing_anuncios": "Marketing / Publicité",
            "vendas_vista": "Ventes au Comptant",
            "vendas_cartao_pix": "Ventes Carte / Pix",
            "vendas_parceladas": "Ventes Échelonnées",
            "aluguel_prestacao_casa": "Loyer / Prêt Immobilier",
            "agua_gas_energia": "Eau, Gaz et Électricité",
            "impostos_taxas_geral": "Impôts et Taxes",
            "investimentos_reservas": "Investissements et Réserves",
            "transportes_combustivel": "Transport et Carburant",
            "alimentacao_supermercado": "Alimentation et Supermarché",
            "saude_farmacia": "Santé et Pharmacie",
            "lazer_outras_despesas": "Loisirs et Autres Dépenses",
            "salario_base": "Salaire de Base",
            "receitas_variaveis": "Revenus Variables (Journées / Extras)",
            "investimentos_rendimentos": "Investissements et Rendements",
            "outros_ganhos": "Autres Gains",
        },
    },
    "Español": {
        ...
        "cat_nomes": {
            "pecas_insumos": "Piezas / Insumos",
            "ferramentas": "Herramientas",
            "equipamentos": "Equipos",
            "manutencao_predial": "Mantenimiento",
            "aluguel": "Alquiler",
            "impostos_taxas": "Impuestos / Tasas",
            "outras_despesas": "Otros Gastos",
            "pagamento_clientes": "Pago de Clientes",
            "servicos_realizados": "Servicios Realizados",
            "venda_pecas": "Venta de Piezas",
            "orcamentos_aprovados": "Presupuestos Aprobados",
            "salario": "Salario",
            "outras_receitas": "Otros Ingresos",
            "materiais_construcao": "Materiales de Construcción",
            "mao_de_obra": "Mano de Obra / Subcontratados",
            "combustivel_frete": "Combustible / Flete",
            "medicao_obra": "Medición de Obra",
            "adiantamento_sinal": "Anticipo / Seña",
            "venda_sobras": "Venta de Sobrantes",
            "softwares_assinaturas": "Software / Suscripciones",
            "hospedagem_servidores": "Hosting / Servidores",
            "marketing": "Marketing",
            "cursos_capacitacao": "Cursos / Capacitación",
            "desenvolvimento_projetos": "Desarrollo de Proyectos",
            "consultoria": "Consultoría",
            "suporte_mensal": "Soporte Mensual",
            "aquisicao_mercadorias": "Adquisición de Mercancías",
            "embalagens": "Embalajes",
            "frete_logistica": "Flete / Logística",
            "marketing_anuncios": "Marketing / Anuncios",
            "vendas_vista": "Ventas al Contado",
            "vendas_cartao_pix": "Ventas con Tarjeta / Pix",
            "vendas_parceladas": "Ventas en Cuotas",
            "aluguel_prestacao_casa": "Alquiler / Cuota de Casa",
            "agua_gas_energia": "Agua, Gas y Electricidad",
            "impostos_taxas_geral": "Impuestos y Tasas",
            "investimentos_reservas": "Inversiones y Reservas",
            "transportes_combustivel": "Transporte y Combustible",
            "alimentacao_supermercado": "Alimentación y Supermercado",
            "saude_farmacia": "Salud y Farmacia",
            "lazer_outras_despesas": "Ocio y Otros Gastos",
            "salario_base": "Salario Base",
            "receitas_variaveis": "Ingresos Variables (Diarias / Extras)",
            "investimentos_rendimentos": "Inversiones y Rendimientos",
            "outros_ganhos": "Otros Ingresos",
        },
    },
    "Italiano": {
        ...
        "cat_nomes": {
            "pecas_insumos": "Ricambi / Materiali",
            "ferramentas": "Utensili",
            "equipamentos": "Attrezzatura",
            "manutencao_predial": "Manutenzione",
            "aluguel": "Affitto",
            "impostos_taxas": "Tasse / Imposte",
            "outras_despesas": "Altre Spese",
            "pagamento_clientes": "Pagamenti Clienti",
            "servicos_realizados": "Servizi Eseguiti",
            "venda_pecas": "Vendita Ricambi",
            "orcamentos_aprovados": "Preventivi Approvati",
            "salario": "Stipendio",
            "outras_receitas": "Altre Entrate",
            "materiais_construcao": "Materiali Edili",
            "mao_de_obra": "Manodopera / Subappalti",
            "combustivel_frete": "Carburante / Trasporto",
            "medicao_obra": "Stato Avanzamento Lavori",
            "adiantamento_sinal": "Acconto",
            "venda_sobras": "Vendita Surplus",
            "softwares_assinaturas": "Software / Abbonamenti",
            "hospedagem_servidores": "Hosting / Server",
            "marketing": "Marketing",
            "cursos_capacitacao": "Corsi / Formazione",
            "desenvolvimento_projetos": "Sviluppo Progetti",
            "consultoria": "Consulenza",
            "suporte_mensal": "Supporto Mensile",
            "aquisicao_mercadorias": "Acquisto Merce",
            "embalagens": "Imballaggi",
            "frete_logistica": "Spedizione / Logistica",
            "marketing_anuncios": "Marketing / Annunci",
            "vendas_vista": "Vendite in Contanti",
            "vendas_cartao_pix": "Vendite Carta / Pix",
            "vendas_parceladas": "Vendite Rateali",
            "aluguel_prestacao_casa": "Affitto / Mutuo Casa",
            "agua_gas_energia": "Acqua, Gas ed Elettricità",
            "impostos_taxas_geral": "Tasse e Imposte",
            "investimentos_reservas": "Investimenti e Riserve",
            "transportes_combustivel": "Trasporti e Carburante",
            "alimentacao_supermercado": "Spesa Alimentare",
            "saude_farmacia": "Salute e Farmacia",
            "lazer_outras_despesas": "Tempo Libero e Altre Spese",
            "salario_base": "Stipendio Base",
            "receitas_variaveis": "Entrate Variabili (Giornate / Extra)",
            "investimentos_rendimentos": "Investimenti e Rendimenti",
            "outros_ganhos": "Altri Guadagni",
        },
    },
    "Deutsch": {
        ...
        "cat_nomes": {
            "pecas_insumos": "Teile / Verbrauchsmaterial",
            "ferramentas": "Werkzeuge",
            "equipamentos": "Ausstattung",
            "manutencao_predial": "Gebäudewartung",
            "aluguel": "Miete",
            "impostos_taxas": "Steuern / Gebühren",
            "outras_despesas": "Sonstige Ausgaben",
            "pagamento_clientes": "Kundenzahlungen",
            "servicos_realizados": "Erbrachte Dienstleistungen",
            "venda_pecas": "Teileverkauf",
            "orcamentos_aprovados": "Genehmigte Budgets",
            "salario": "Gehalt",
            "outras_receitas": "Sonstige Einnahmen",
            "materiais_construcao": "Baumaterialien",
            "mao_de_obra": "Arbeitskräfte / Subunternehmer",
            "combustivel_frete": "Kraftstoff / Fracht",
            "medicao_obra": "Bauabrechnung",
            "adiantamento_sinal": "Vorschuss / Anzahlung",
            "venda_sobras": "Restverkauf",
            "softwares_assinaturas": "Software / Abonnements",
            "hospedagem_servidores": "Hosting / Server",
            "marketing": "Marketing",
            "cursos_capacitacao": "Kurse / Schulungen",
            "desenvolvimento_projetos": "Projektentwicklung",
            "consultoria": "Beratung",
            "suporte_mensal": "Monatlicher Support",
            "aquisicao_mercadorias": "Warenerwerb",
            "embalagens": "Verpackung",
            "frete_logistica": "Fracht / Logistik",
            "marketing_anuncios": "Marketing / Werbung",
            "vendas_vista": "Barverkäufe",
            "vendas_cartao_pix": "Kartenzahlung / Pix",
            "vendas_parceladas": "Ratenverkäufe",
            "aluguel_prestacao_casa": "Miete / Hauskredit",
            "agua_gas_energia": "Wasser, Gas und Strom",
            "impostos_taxas_geral": "Steuern und Gebühren",
            "investimentos_reservas": "Investitionen und Rücklagen",
            "transportes_combustivel": "Transport und Kraftstoff",
            "alimentacao_supermercado": "Lebensmittel und Supermarkt",
            "saude_farmacia": "Gesundheit und Apotheke",
            "lazer_outras_despesas": "Freizeit und Sonstige Ausgaben",
            "salario_base": "Grundgehalt",
            "receitas_variaveis": "Variables Einkommen (Tagelöhner / Extras)",
            "investimentos_rendimentos": "Investitionen und Renditen",
            "outros_ganhos": "Sonstige Einnahmen",
        },
    },
}
...
TEXTOS = {
    "Português": {
        ...
        "login_sub": (
            "Entre com sua conta ou cadastre-se escolhendo o seu perfil."
        ),
        "tab_login": "🔑 Entrar",
        ...
        "new_sub": (
            "Adicione uma nova receita ou despesa detalhando o que foi gasto."
        ),
        ...
        "profile_sub": (
            "Atualize suas informações cadastrais, senha, ramo ou foto de"
            " perfil."
        ),
        ...
        "info_pessoal": (
            "Criação de conta estritamente pessoal (sem exigência de ramo"
            " profissional ou oficina)."
        ),
        "info_prof": (
            "Criação de conta profissional voltada para o seu setor de mercado."
        ),
    },
    "English": {
        "login_title": "My Finance Access",
        "login_sub": (
            "Log in to your account or choose your profile type to register."
        ),
        "tab_login": "🔑 Log In",
        ...
        "info_pessoal": (
            "Strictly personal account creation (no professional or workshop"
            " branch required)."
        ),
        "info_prof": (
            "Professional account creation tailored to your market sector."
        ),
    },
    "Français": {
        "login_title": "Accès à Mon Financier",
        "login_sub": (
            "Connectez-vous ou choisissez votre profil pour vous inscrire."
        ),
        "tab_login": "🔑 Connexion",
        ...
        "reg_error": (
            "Cet utilisateur existe déjà ou une erreur est survenue."
        ),
        ...
        "no_data": (
            "Aucune donnée pour l'instant. Allez dans '➕ Nouvelle Entrée'."
        ),
        ...
        "info_pessoal": (
            "Création de compte strictement personnel (sans exigence de secteur"
            " professionnel ou d'atelier)."
        ),
        "info_prof": (
            "Création de compte professionnel adapté à votre secteur de marché."
        ),
    },
    "Español": {
        ...
        "info_pessoal": (
            "Creación de cuenta estrictamente personal (sin requerir sector"
            " profesional o taller)."
        ),
        "info_prof": (
            "Creación de cuenta profesional adaptada a tu sector de mercado."
        ),
    },
    "Italiano": {
        ...
        "info_pessoal": (
            "Creazione account strettamente personale (senza requisiti di"
            " settore professionale o officina)."
        ),
        "info_prof": (
            "Creazione account professionale su misura per il tuo settore di"
            " mercato."
        ),
    },
    "Deutsch": {
        ...
        "login_sub": (
            "Melden Sie sich an oder wählen Sie Ihr Profil zur Registrierung."
        ),
        "tab_login": "🔑 Anmelden",
        ...
        "info_pessoal": (
            "Streng persönliches Konto (kein Berufszweig oder Werkstatt"
            " erforderlich)."
        ),
...
MOEDAS = {"Real (R$)": "R$", "Euro (€)": "€", "Dólar ($)": "$", "Libra (£)": "£"}
...
if not st.session_state["logged_in"]:
  ...
  with col2:
    st.markdown(
        f"<h2 style='text-align: center;'>{t_login['login_title']}</h2>",
        unsafe_allow_html=True,
    )
    st.markdown(
        f"<p style='text-align: center; color: gray;'>{t_login['login_sub']}</p>",
        unsafe_allow_html=True,
    )
    ...
    with tab_login:
      with st.form("form_login"):
        ...
        submit_login = st.form_submit_button(
            t_login["btn_login_submit"], use_container_width=True
        )
    ...
    with tab_reg_pessoal:
      with st.form("form_reg_pessoal"):
        ...
        reg_pass_p = st.text_input(
            t_login["reg_pass_label"], type="password", key="reg_p_p"
        )

        submit_reg_p = st.form_submit_button(
            t_login["btn_reg_submit"], use_container_width=True
        )
    ...
    with tab_reg_prof:
      with st.form("form_reg_prof"):
        ...
        reg_user_prof = st.text_input(
            t_login["reg_user_label"], key="reg_u_prof"
        )
        reg_name_prof = st.text_input(
            t_login["reg_name_label"], key="reg_n_prof"
        )
        reg_pass_prof = st.text_input(
            t_login["reg_pass_label"], type="password", key="reg_p_prof"
        )
        ...
        reg_branch_ui = st.selectbox(
            t_login["reg_branch_label"],
            opcoes_ramos_reg,
            key="reg_branch_prof",
        )

        submit_reg_prof = st.form_submit_button(
            t_login["btn_reg_submit"], use_container_width=True
        )
        ...
        if submit_reg_prof:
          if reg_user_prof and reg_name_prof and reg_pass_prof:
            ...
            if cadastrar_usuario(
                reg_user_prof, reg_name_prof, reg_pass_prof, chave_ramo
            ):
              st.success(t_login["reg_success"])
            else:
              st.error(t_login["reg_error"])
  ...
  ramo_usuario_db = (
      dados_user[3]
      if dados_user and len(dados_user) > 3 and dados_user[3]
      else "outros"
  )
  ...
  ramo_usuario_exibicao = ramos_dict.get(
      ramo_usuario_db, ramos_dict["outros"]
  )
  ...
  if menu == t["nav_overview"]:
    ...
    if df.empty:
      ...
      total_receitas = df_mes[
          df_mes["tipo_exibicao"] == ramos_dict["tipo_receita"]
      ]["valor"].sum()
      total_despesas = df_mes[
          df_mes["tipo_exibicao"] == ramos_dict["tipo_despesa"]
      ]["valor"].sum()

      df_inv_mes = df_mes[
          df_mes["categoria"].str.contains(
              "investimento|reserva", case=False, na=False
          )
      ]
      ...
      hist_rec = df_historico[
          df_historico["tipo_exibicao"] == ramos_dict["tipo_receita"]
      ]["valor"].sum()
      hist_esp = df_historico[
          df_historico["tipo_exibicao"] == ramos_dict["tipo_despesa"]
      ]["valor"].sum()
      ...
      investimento_total = (
          df_inv_total["valor"].sum() if not df_inv_total.empty else 0.0
      )
      ...
      with col1:
        st.metric(
            label="💰 Receitas do Mês", value=f"{simbolo_moeda} {total_receitas:,.2f}"
        )
        st.metric(
            label="⚡ Saldo do Mês", value=f"{simbolo_moeda} {saldo_mes:,.2f}"
        )
        st.metric(
            label="💎 Total Investido (Acumulado)",
            value=f"{simbolo_moeda} {investimento_total:,.2f}",
        )

      with col2:
        st.metric(
            label="💸 Despesas do Mês",
            value=f"{simbolo_moeda} {total_despesas:,.2f}",
        )
        st.metric(
            label="📈 Investimento do Mês",
            value=f"{simbolo_moeda} {investimento_mes:,.2f}",
        )
        st.metric(
            label="🏦 Saldo Real na Conta",
            value=f"{simbolo_moeda} {saldo_real_conta:,.2f}",
        )
      ...
      df_exibicao_tabela = df_mes[
          ["data", "tipo_exibicao", "categoria_exibicao", "descricao", "valor"]
      ].copy()
      df_exibicao_tabela.columns = [
          "Data",
          "Tipo",
          "Categoria",
          "Descrição",
    ...
    if df.empty:
      ...
      mes_selecionado = st.selectbox(
          "📅 Mês de Análise (Business)", meses_disponiveis, key="sel_mes_biz"
      )
      ...
      custos = df_mes[df_mes["tipo_exibicao"] == ramos_dict["tipo_despesa"]][
          "valor"
      ].sum()
      ...
      with bc2:
        ...
        if not df_desp.empty:
          fig_desp = px.bar(
              df_desp,
              x="categoria_exibicao",
              y="valor",
              title=t["highest_costs"],
              color="categoria_exibicao",
          )
          st.plotly_chart(
              fig_desp,
              use_container_width=True,
      ...
      colunas_relatorio = (
          ...
          if "veiculo" in df_mes.columns
          else ["data", "tipo_exibicao", "categoria_exibicao", "descricao", "valor"]
      )
      df_biz_tab = df_mes[
          [c for c in colunas_relatorio if c in df_mes.columns]
      ].copy()
      df_biz_tab.columns = (
          ["Data", "Tipo", "Categoria", "Descrição", "Veículo", "Valor"]
          if "veiculo" in colunas_relatorio
          else ["Data", "Tipo", "Categoria", "Descrição", "Valor"]
      )
    ...
    ramo_chave_atual = (
        ramo_usuario_db if ramo_usuario_db in CATEGORIAS_CHAVES else "outros"
    )
    ...
    if st.button(t["save_btn"], use_container_width=True):
      if desc_lanc.strip() != "":
        tipo_para_salvar = (
            "Despesa"
            if tipo_lanc_ui == ramos_dict["tipo_despesa"]
            else "Receita"
        )
    ...
    ramo_atual_db = (
        dados_atuais[3]
        if dados_atuais and len(dados_atuais) > 3 and dados_atuais[3]
        else "outros"
    )
    ...
    idx_ramo = (
        opcoes_ramos_perfil.index(ramo_atual_ui)
        if ramo_atual_ui in opcoes_ramos_perfil
        else 0
    )
    ...
    with st.form("form_perfil"):
      ...
      novo_ramo_ui = st.selectbox(
          t["reg_branch_label"], opcoes_ramos_perfil, index=idx_ramo
      )
      nova_senha = st.text_input(t["new_pass_label"], type="password")

      foto_upload = st.file_uploader(
          t["photo_label"], type=["png", "jpg", "jpeg"]
      )
